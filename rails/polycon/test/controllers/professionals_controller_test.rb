...
class ProfessionalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post professionals_url, params: { professional: { first_name: @professional.first_name, last_name: @professional.last_name } }
    end
  ...
  test "should update professional" do
    patch professional_url(@professional), params: { professional: { first_name: @professional.first_name, last_name: @professional.last_name } }
