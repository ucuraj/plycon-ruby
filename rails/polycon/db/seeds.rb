...
Appointment.create([{ date: Time.new(2021, 12, 12, 15, 30), observations: "Turno numero uno", patient: (patients.at 0), professional: professionals.first },
                    ...
                    { date: Time.new(2021, 12, 27, 13, 30), observations: "Turno numero siete", patient: (patients.at 0), professional: professionals.last },
                    { date: Time.new(2022, 1, 2, 13, 30), observations: "Turno numero siete", patient: (patients.at 0), professional: professionals.last },
                    { date: Time.new(2022, 1, 2, 10, 30), observations: "Turno numero siete", patient: (patients.at 1), professional: professionals.first },
                    { date: Time.new(2022, 1, 3, 8, 30), observations: "Turno numero siete", patient: (patients.at 2), professional: professionals.last },
                    { date: Time.new(2022, 1, 3, 9, 0), observations: "Turno numero siete", patient: (patients.at 3), professional: professionals.first },
                    { date: Time.new(2022, 1, 3, 12, 15), observations: "Turno numero siete", patient: (patients.at 2), professional: professionals.last },
                    { date: Time.new(2022, 1, 4, 10, 30), observations: "Turno numero siete", patient: (patients.at 0), professional: professionals.first },
                   ])
